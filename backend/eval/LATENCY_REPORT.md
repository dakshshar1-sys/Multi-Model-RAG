...
- **149 requests**, 2026-09-20T18:57:29 → 2026-09-21T16:06:37 UTC
- End to end, uncached: **p50 10.4 s · p90 21.6 s · p95 25.4 s** · max 80.9 s
- Cache hits 0.7% · degraded searches 0.0% · answers with a chart 3.4% · declined (not in the knowledge base) 0.7%
- Verification verdicts: not run 14, flagged 37, pass 98
- Request sources (conversation id → count): ablation 128, profile 6, profile2 6, probe-check 3, floor-check 3, trace-demo 2, probe-email 1

## End-to-end time by tool

| tool | n | p50 s | p90 s | p95 s | mean s | max s |
|---|---|---|---|---|---|---|
| Search_Knowledge_Base | 69 | 4.3 | 8.8 | 11.3 | 5.2 | 16.5 |
| Web_Search | 65 | 18.7 | 24.7 | 30.6 | 19.1 | 42.1 |
...
|---|---|---|---|---|---|
| Generation | 137 | 5.2 | 9.0 | 10.7 | 41.4% |
| Web Search | 67 | 7.7 | 12.5 | 14.8 | 32.9% |
| Agent Router | 148 | 0.9 | 1.1 | 1.1 | 6.2% |
| Reranking Model | 69 | 1.0 | 1.3 | 1.4 | 3.7% |
| Email Agent | 5 | 2.8 | 6.1 | 6.2 | 1.0% |
| Visualizer Agent | 100 | 0.0 | 0.0 | 0.0 | 0.5% |
| Workspace Agent | 2 | 2.3 | 2.9 | 2.9 | 0.3% |
| Vector Retrieval | 69 | 0.0 | 0.1 | 0.1 | 0.2% |
| Direct Chat | 2 | 0.9 | 1.0 | 1.0 | 0.1% |
| Master LLM Orchestrator | 148 | 0.0 | 0.0 | 0.0 | 0.0% |
| Embedding Model | 69 | 0.0 | 0.0 | 0.0 | 0.0% |
| Verification Module | 135 | 0.0 | 0.0 | 0.0 | 0.0% |
| Final Response | 148 | 0.0 | 0.0 | 0.0 | 0.0% |
